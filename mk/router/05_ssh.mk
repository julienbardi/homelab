...
router-ssh-check: install-ssh-config
	...
	@ssh -p $(ROUTER_SSH_PORT) -o BatchMode=yes -o ConnectTimeout=5 $(ROUTER_HOST) true >/dev/null 2>&1 || ( echo "❌ SSH reachable but authentication failed"; exit 1; )
