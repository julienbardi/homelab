...
$(WG_SUBNETS_MK): $(WG_ROOT)/input/wg-interfaces.tsv $(INSTALL_PATH)/wg-plan-subnets.sh ensure-stamps
...
$(WG_INTERFACE_LIST_STAMP): $(WG_ROOT)/input/wg-interfaces.tsv ensure-stamps
