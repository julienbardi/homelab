...
PRESERVE_ENV="DEBIAN_FRONTEND,SRC_ATTIC_CONFIG,SRC_ATTIC_SERVICE,ATTIC_REF,WG_ROOT,VERBOSE,HOMELAB_DIR,ROUTER_ADDR,SSH_USER_ROUTER,ROUTER_SSH_PORT,SSH_OPTS"
