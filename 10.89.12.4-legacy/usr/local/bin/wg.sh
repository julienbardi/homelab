...
# Script: wg.sh
# to deploy use 
#     sudo cp /home/julie/homelab/10.89.12.4/usr/local/bin/wg.sh /usr/local/bin/
set -euo pipefail
...
# CRITICAL FIX: Quote all commands to prevent the parser from confusing '=' within 
# the shell command with a parameter assignment (e.g., PostUp="command...").
