...
help:
	...
	@echo "    make wireguard           # Wireguard orchestration (requires router setup)"
	@echo "    make wg0..wg7            # Ensure server config and keys for wg0..wg7"
	@echo "    make wg-up-<N>          # Bring up wgN (idempotent)"
	...
	@echo "    make all-wg             # Ensure all wgN configs"
	...
	@echo "    make wg-add-peers       # Ensure server peer blocks from CLIENTS variable"
